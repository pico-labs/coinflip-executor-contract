import { isReady, shutdown, Mina, PrivateKey, PublicKey, MerkleMap, Field, Poseidon, } from 'snarkyjs';
import { Executor } from './executor.js';
await isReady;
console.log('compiling...');
await Executor.compile();
console.log('compiled!');
const executorPublicKey = PublicKey.fromBase58('B62qjb2oGVMGiPad6GKTBh6MqgFJ3ExhkfegBuUiynLoyCSbTfM62vW');
...
const tx = await Mina.transaction({ feePayerKey: player1PrivateKey, fee: 100000000 }, () => {
...
await tx.send();
shutdown();
//# sourceMappingURL=berkeleyRun.js.map